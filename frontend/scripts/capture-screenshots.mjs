...
const nodes = [
  {
    ...
    agent_base_url: 'http://hk01.demo.raypilot.test:8080',
    is_enabled: true,
  ...
  },
  {
    ...
    agent_base_url: 'http://us01.demo.raypilot.test:8080',
    is_enabled: true,
  ...
  },
  {
    ...
    host: 'us-home-1.demo.raypilot.test',
    port: 443,
    server_name: 'www.microsoft.com',
    ...
    agent_base_url: 'http://us-home-agent.demo.raypilot.test:8080',
    is_enabled: true,
  ...
  },
  {
    ...
    host: 'us-home-2.demo.raypilot.test',
    port: 8443,
    server_name: 'www.microsoft.com',
